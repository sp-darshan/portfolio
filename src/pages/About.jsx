    ...
    >
      <div className="w-full max-w-6xl px-8">
        ...
        <div className='flex w-full gap-12'>
          <div className="flex-1 text-lg text-gray-300 leading-relaxed max-w-4xl space-y-4 text-justify">
          ...
          <div className='flex-1 flex flex-col gap-6 justify-center'>
            ...
            <div className="bg-white/3 border border-white/10 border-opacity-30 rounded-xl p-6 cursor-pointer transition-all hover:scale-105 hover:shadow-lg hover:shadow-green-400/50 hover:border-opacity-60">
